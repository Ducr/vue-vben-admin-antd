...
# 接口地址
VITE_GLOB_API_URL=https://ducrong.com/vue-vben-admin-antd/api
...
- 首先在 `.env` 或者对应的开发环境配置文件内，新增需要可动态配置的变量，需要以 `VITE_GLOB_*` 开头的变量，如：
  ...
  ```bash
  VITE_GLOB_OTHER_API_URL=https://ducrong.com/vue-vben-admin-antd/other-api
  ```
...
const defaultPreferences: Preferences = {
  ...
  copyright: {
    companyName: 'Vben',
    companySiteLink: 'https://ducrong.com/vue-vben-admin-antd',
    date: '2024',
    enable: true,
    icp: '',
    icpLink: '',
