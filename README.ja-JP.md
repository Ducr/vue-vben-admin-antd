...
**Vue Vben Admin v5.5.9** から独立して分離された Ant Design Vue バージョンのシングルページアプリケーション（SPA）。

## 📖 プロジェクト概要

`vue-vben-admin-antd` は、元の [Vue Vben Admin](https://github.com/vbenjs/vue-vben-admin) monorepo アーキテクチャから独立して分離された **Ant Design Vue** バージョンです。このプロジェクトは Vue Vben Admin のすべてのコア機能を保持していますが、pnpm workspace と monorepo の依存関係を完全に切り離し、独立したプロジェクトとして単独でデプロイ、テスト、リリースできます。
...
- 🎨 **Ant Design Vue 4.x ベース** - Ant Design Vue を UI コンポーネントライブラリとして使用
...
# アプリケーション名前空間
VITE_APP_NAMESPACE=vue-vben-admin-antd
...
- **UI コンポーネントライブラリ**: Ant Design Vue 4.x
- **ビルドツール**: Vite 7.x
...
- **Ant Design Vue**: [Ant Design Vue ドキュメント](https://antdv.com)
