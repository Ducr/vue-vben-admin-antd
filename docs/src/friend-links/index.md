...
- 通过 GitHub Issues 联系：[提交 Issue](https://github.com/Ducr/vue-vben-admin-antd/issues)
- 通过微信联系作者：
...
- 在您的网站上添加我们的友情链接，链接如下：
  - 名称：Vben Admin Antd
  - 链接：https://ducrong.com/vue-vben-admin-antd
  - 描述：Vben Admin Antd - 基于 Vue Vben Admin v5.5.9 独立拆分的 Ant Design Vue 版本单页应用（SPA）
