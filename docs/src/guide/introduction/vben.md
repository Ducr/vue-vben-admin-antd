...
::: info 你正在阅读的是 [Vue Vben Admin Antd](https://github.com/Ducr/vue-vben-admin-antd) `5.0`版本的文档！
...
- [Vue Vben Admin Antd](https://github.com/Ducr/vue-vben-admin-antd) 还在持续更新中，本项目欢迎您的参与，共同维护，逐步完善，打造更好的中后台解决方案。
