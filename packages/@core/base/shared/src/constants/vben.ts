 ...
 * @zh_CN GITHUB 仓库地址
 */
export const VBEN_GITHUB_URL = 'https://github.com/Ducr/vue-vben-admin-antd';

/**
 * @zh_CN 文档地址
 */
export const VBEN_DOC_URL = 'https://ducrong.com/vue-vben-admin-antd/docs';
 ...
 */
export const VBEN_PREVIEW_URL = 'https://ducrong.com/vue-vben-admin-antd';
