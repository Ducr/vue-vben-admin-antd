...
::: info You are reading the documentation for [Vue Vben Admin Antd](https://github.com/Ducr/vue-vben-admin-antd) version `5.0`!
...
- [Vue Vben Admin Antd](https://github.com/Ducr/vue-vben-admin-antd) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
