...
基于 **Vue Vben Admin v5.5.9** 独立拆分而来的 Ant Design Vue 版本单页应用（SPA）。

## 📖 项目简介

`vue-vben-admin-antd` 是从原始 [Vue Vben Admin](https://github.com/vbenjs/vue-vben-admin) monorepo 架构中独立拆分出来的 **Ant Design Vue** 版本。本项目保留了 Vue Vben Admin 的所有核心功能特性，但完全脱离 pnpm workspace 和 monorepo 依赖，可作为独立项目单独部署、测试和发布。
...
- 🎨 **基于 Ant Design Vue 4.x** - 使用 Ant Design Vue 作为 UI 组件库
...
- **Ant Design Vue**: [Ant Design Vue 文档](https://antdv.com)
